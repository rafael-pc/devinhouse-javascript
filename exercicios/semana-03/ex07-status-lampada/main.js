...
function ligaDesliga() {
    ...
    if (statusLampada) {
        imgLampada.setAttribute('src', 'https://raw.githubusercontent.com/phmonte/devinhouse/main/Aulas/Javascript/imagens/luz-acesa.png');
        localStorage.setItem('imagem', imgLampada.src)
        texto = " Luz acessa"
        localStorage.setItem('text', texto)   
    } else {
        imgLampada.setAttribute('src', 'https://raw.githubusercontent.com/phmonte/devinhouse/main/Aulas/Javascript/imagens/luz-apagada.png');
        localStorage.setItem('imagem', imgLampada.src)
        texto = " Luz apagada"
        localStorage.setItem('text', texto)
    }
