...
btn.addEventListener('click', () => {
    ...
    const enderecoCliente = new Endereco(logradouroCliente.value, numeroCliente.value, cidadeCliente.value, estadoCliente.value, paisCliente.value, cepCliente.value)
    const enderecoLoja = new Endereco(logradouroLoja.value, numeroLoja.value, cidadeLoja.value, estadoLoja.value, paisLoja.value, cepLoja.value)
    const enderecoMercado = new Endereco(logradouroMercado.value, numeroMercado.value, cidadeMercado.value, estadoMercado.value, paisMercado.value, cepMercado.value)
